      ...
      "messages": [
        {
          ...
          \"budget_plan\": {
            \"Магазинные товары\": X, //траты на продукты
            \"Общественный транспорт\": X, //траты на общественный транспорт
            \"ЖКУ\": X, //траты на жкх
            \"Здоровье\": X, //траты на медицину
            \"Хобби": X, //траты на хобби
            \"Кредиты\": X, //траты по кредиту
            \"Дополнительные категории\": {описание: X}, //вписать новые категории, если созданы
          }
          }
